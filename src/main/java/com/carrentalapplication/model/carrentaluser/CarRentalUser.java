package com.carrentalapplication.model.carrentaluser;
...
public class CarRentalUser {
    ...
    private CarRentalUser() {

    }

    public CarRentalUser(String userName, String firstName, String lastName, String password) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CarRentalUser)) return false;
        CarRentalUser that = (CarRentalUser) o;
